...
const Paciente = ({paciente,setPaciente,eliminarPaciente}) => {
  ...
  const handleEliminar=()=>{console.log("eliminando..")}  
  return (
  
<div className = "m-3 bg-white shadow-md px-5 py-10 rounded-xld text-left">
...
<p className=" font-bold mb-3 text-gray-700  uppercase">{sintomas}:{''}         
    ...
    <div className='flex justify-around '>
        <button type='button' className='py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white font-bold
         uppercase rounded-lg' onClick={()=> setPaciente(pacientes)}>
               Editar    
        </button>
